...
export const expensesApi = {
  ...
  getHistory: (id: string) =>
    api.get<{ success: boolean; data: Array<{ id: number; action: string; oldData: any; newData: any; createdAt: string; user: { id: string; name: string } | null }> }>(`/expenses/${id}/history`),
};
