      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-gray-50">
        <div className="w-full max-w-sm">
          ...
          <div className="flex lg:hidden items-center justify-center gap-3 mb-8">
            <ServingmiLogo className="w-10 h-12" />
            <div>
              <p className="font-bold text-gray-900 text-xl tracking-widest">SERVINGMI</p>
              <p className="text-xs text-gray-500">Servicios Ingenieriles &amp; Mineros</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              ...
              <input
                type="email"
                placeholder="correo@servingmi.com"
          ...
          <p className="text-center text-xs text-gray-300 mt-1">
            Desarrollado por <span className="text-gray-400">Ing. Jhonny Tavarez Arias</span> · Cowork Claude AI
          </p>
        </div>
      </div>
    </div>
