#!/usr/bin/env node
/**
 * ServingMI smoke / screenshot driver.
 * Usage:  node .claude/skills/run-servingmi/driver.mjs [command]
 *
 * Commands
 ...
 * skill generation). If that directory is gone, run:
